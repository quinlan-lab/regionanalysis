...
plt.plot(fpr,tpr,label='CCR AUC = '+str(AUC), color = 'b')
...
fpr, tpr, thresholds = metrics.roc_curve(y, scores, pos_label=1)
AUC=metrics.roc_auc_score(y, scores)
plt.plot(fpr,tpr,label='CCR w/gnomAD AUC = '+str(AUC), color = 'm')
...
fpr, tpr, thresholds = metrics.roc_curve(y, scores, pos_label=1)
AUC=metrics.roc_auc_score(y, scores)
plt.plot(fpr,tpr,label='pLI AUC = '+str(AUC), color = 'g')
...
fpr, tpr, thresholds = metrics.roc_curve(y, scores, pos_label=1)
AUC=metrics.roc_auc_score(y, scores)
plt.plot(fpr,tpr,label='CADD AUC = '+str(AUC), color = 'r')
plt.title(title)
