...
lengths = []
for i, d in enumerate(ts.reader('exacresiduals/results/unfiltered/exac-regions-novariant.txt', header="ordered")):
...
ax.bar(p_edges[:-1], p, width = width_p, color = 'red', label = 'pathogenic', alpha = 0.5)
ax.set_ylabel("Count")
ax.set_yscale("log")
...
sns.despine()
plt.savefig('/uufs/chpc.utah.edu/common/home/u1021864/public_html/randomplots/distances.pdf', bbox_inches='tight')
