...
parser.add_argument("-f", "--file", help="regions file for analysis", required=True)
parser.add_argument("-p", "--percentiletest", action="store_true", help="plots percentile distribution plot")
#parser.set_defaults(file="$HOME/analysis/exacresiduals/results/2017_04_09/weightedresiduals-cpg-novariant.txt")
args=parser.parse_args()
infile=args.file
percentiletest=args.percentiletest
