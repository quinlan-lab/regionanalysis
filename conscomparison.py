...
if not os.path.isfile("var.pickle"):
    ...
    var={}
    var['gerp']=gerp; var['phast']=phast; var['cadd']=cadd; var['toptengerp']=toptengerp; var['toptenphast']=toptenphast; var['toptencadd']=toptencadd; var['topgerp']=topgerp; var['topphast']=topphast; var['topcadd']=topcadd; var['ccrpct']=ccrpct; var['topccr']=topccr
    pickle.dump(var, open("var.pickle", "wb"))

var = pickle.load(open("var.pickle", "rb"))
gerp=var['gerp']; phast=var['phast']; cadd=var['cadd']; toptengerp=var['toptengerp']; toptenphast=var['toptenphast']; toptencadd=var['toptencadd']; topgerp=var['topgerp']; tophphast=var['topphast']; topcadd=var['topcadd']; ccrpct=var['ccrpct']; topccr=var['topccr']
